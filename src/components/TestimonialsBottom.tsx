...
const testimonials = [
  {
    ...
    text: "Armé los roles, hice el primer simulacro real y por fin tengo todo documentado.",
  },
  {
    initial: "D",
    ...
    text: "El Kit de Simulacros cambió todo: guion, planilla de observación e informe. La ART quedó impresionada.",
  },
  {
    initial: "P",
    ...
    text: "Ahora cada brigadista tiene su guion y sabe exactamente qué hacer ante un incendio.",
  },
  {
    initial: "H",
    ...
    text: "Cuando vino Bomberos tenía todo listo: plan, registros y fichas de brigadistas. Cero observaciones.",
  },
];
    ...
    <section className=" md:py-14 bg-transparent">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-8 flex flex-col items-center">
          <MessageCircle className="w-10 h-10 text-[#E8A33D] mb-3" />
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-[#241F1D]">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              <div className="flex text-[#E8A33D] mb-3">
                {[...Array(5)].map((_, i) => (
              ...
              <div className="flex items-center border-t border-slate-100 pt-3 mt-auto">
                ...
                <div>
                  <div className="font-bold text-[#241F1D] text-sm">
                    {t.name}
                  </div>
