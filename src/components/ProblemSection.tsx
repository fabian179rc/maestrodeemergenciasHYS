    ...
    <section className="py-16 md:py-24 bg-[#e3f1eb] pt-[30px] pb-[30px]">
      <div className="container mx-auto px-4 max-w-[1100px]">
        <div className="text-center mb-12">
          <h2 className="font-heading text-3xl md:text-5xl font-semibold mb-4 text-[#1c3733] uppercase">
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-white p-8 rounded-2xl shadow-sm border border-[#dde8e4]">

              <div className="text-4xl mb-4">{item.emoji}</div>
              <h3 className="text-xl font-bold text-[#1c3733] mb-3">
                {item.title}
              </h3>
              <p className="text-[#4f6b66] leading-relaxed text-[16px]">
                {item.desc}
              </p>
            </motion.div>
          )}
